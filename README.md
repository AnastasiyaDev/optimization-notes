...
1. <span style="background-color: #b65959;">Что происходит?</span> Произошла ли навигация успешно;
...
4. <span style="background-color: #b65959;">Это восхитительно?</span> Испытывал ли пользователь негативный опыт зависания скролла, анимация, медленных шрифтов.
