...
* **Rendering Tree** - браузер "склеивает" DOM, CSSOM и JS, браузер уже понимает как будет выглядить сайт
...
Лучшее свойства для рендеринга: `transform` и `opacity` (пропускают этапы **Layout** и **Paint**)
